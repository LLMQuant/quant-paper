...
from quantmind.research import (
    PaperAnalyzer, AnalysisConfig, LLMTagAnalyzer, LLMQAGenerator
)
...
class TestLLMQAGenerator:
    ...
    def test_prepare_context(self):
        ...
        secondary_tags = [PaperTag(tag="lstm", value="algorithm", confidence=0.7)]
        
        config = AnalysisConfig()
        generator = LLMQAGenerator(config)
        context = generator._prepare_context(paper, primary_tags, secondary_tags)
